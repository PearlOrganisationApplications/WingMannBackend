...
const { addAvailability, getAvailability,getAllAvailability, updateSpecificAvailability, deleteSpecificSlot, getAllAvailabilityByDate } = require('../controllers/interviewer.controller');
...
router.get("/getAllAvailabilityByDate", getAllAvailabilityByDate);
