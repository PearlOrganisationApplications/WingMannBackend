...
const { register, login,uploadMatchPhoto,addRestaurent, getAllRestaurent, getMatchPhotosByAdmin, updateMatchPhoto, deleteMatchPhoto, updateRestaurant, deleteRestaurant   } = require('../controllers/auth.controller');
